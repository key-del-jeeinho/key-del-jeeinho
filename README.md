...
- Clique기반 관계도 분석에 기반한 가게 어뷰징 탐지/제재 프로세스 구축
...
**2025.11 - 현재** 미소 방문이사 OperationManager + ProductOwner (겸직)
- 주문 접수 ~ 방문상담 예약 프로세스 개선
  - 신규 어드민 및 일정배정 24/7 자동화 시스템 기반 인력 효율화 (일 투입인원 3명 -> 0.5명)
  - 플래너 배정 유동화 기반 당일 접수 후 방문 주문건 >2배 증가
  - 주문접수 ~ 방문상담 예약 전환율 >10% 개선 (전환율 85% -> 96.06%)
